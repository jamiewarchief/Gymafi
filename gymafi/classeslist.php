            ...
            <main class="dash-content mt-5 pt-5">
                ...
                <?php
                    ...
                    while($row=$result->fetch_assoc()) {
                        ...
                        $get_class_name = $conn->real_escape_string($row['class_name']);
                        $get_class_info = $conn->real_escape_string($row['class_info']);
                        ...
                        echo '
                            ...
                            <div class="card w-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-4"><e>with '.$coach_first_name.' '.$coach_last_name.'</em></p>
