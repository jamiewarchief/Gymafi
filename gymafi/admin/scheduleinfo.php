        ...
        <div class="dash-app">
            ...
            <main class="dash-content mt-5 pt-5">
                    ...
                    <?php
                        ...
                        $readclientname = "SELECT first_name, last_name FROM users WHERE id = $client_id";
                        $resultclientname = $conn->query($readclientname);
                        if(!$readclientname) {
                            $conn->error;
                        }
                        while($crow=$resultclientname->fetch_assoc()) {

                        $clientfirstname = $crow['first_name'];
                        $clientlastname = $crow['last_name'];
                        ...
                        <div class="container w-75">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <p class="card-text">with '.$clientfirstname.' '.$clientlastname.'</p>
    ...
    <div class="modal fade" id="deleteapptmodal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <p>We will send a message to your client to notify them.</p>
            </div>
            <div class="modal-footer">
                <form action="deleteappt.php" method="POST">
                    <input type="hidden" name="clientid" value="<?php echo $client_id;?>">
                    <input type="hidden" name="coachid" value="<?php echo $id;?>">
                    <input type="hidden" name="coachname" value="<?php echo $get_first_name;?>">
