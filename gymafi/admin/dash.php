        ...
        <div class="dash-app">
            ...
            <main class="dash-content mt-5 pt-5">
                ...
                <div class="container">
                    ...
                    <div class="jumbotron text-center pt-5 mt-4">
                        <h4>Get started with the panel on the left. Below you can find a sample of some classes that we will soon be featuring.</h4>
                        <hr>
                    </div>    
                    ...
                    <div class="card text-center text-light mb-3 bg-dark">
                        <div class="card-body">
                            <h4>...or view the full list <a href="classeslist.php">here</a></h4>
                        </div>
                    </div>
                </div>
                <br><br><br><br><br><br>
